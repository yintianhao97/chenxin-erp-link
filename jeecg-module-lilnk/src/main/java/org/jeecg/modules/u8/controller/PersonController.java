...
@Api(tags="人员表")
@RestController
@RequestMapping("/u8/person")
public class PersonController extends JeecgController<Person, IPersonService> {
	@Autowired
	...
	public Result<?> queryPageList(Person person,
  ...
  public ModelAndView exportXls(HttpServletRequest request, Person person) {
      return super.exportXls(request, person, Person.class, "人员表");
  }
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      return super.importExcel(request, response, Person.class);
  }
