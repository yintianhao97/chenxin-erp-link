 ...
 */
@Data
@TableName("GSP_VOUCHSUNSALABLE")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="GSP_VOUCHSUNSALABLE对象", description="采购退货出库质量复核记录单辅")
public class Gsp_VouchsUnsalable {
	...
	/**irdsid*/
	@Excel(name = "irdsid", width = 15)
    @ApiModelProperty(value = "irdsid")
	private java.lang.Integer irdsid;
	/**cinvcode*/
	...
	/**cinstance*/
	@Excel(name = "cinstance", width = 15)
    @ApiModelProperty(value = "cinstance")
	private java.lang.String cinstance;
	/**iquantity*/
